...
pbo_dts = PBO_runs[list(PBO_runs.keys())[2]]
...
pbo = PBO_runs[list(PBO_runs.keys())[3]]
...
plt.show()
# Add rectangle
plt.gca().add_patch(patches.Rectangle((0,-3.5),100,0.172,linewidth=1,edgecolor='w',facecolor='w',zorder=2))
...
plt.show()
# Add rectangle
plt.gca().add_patch(patches.Rectangle((0,-0.1),100,0.09735,linewidth=1,edgecolor='w',facecolor='w',zorder=2))
