...
import matplotlib.patches as patches #add rectangles
...
trajectory_name = 'numerical_experiments_trajectory_28-05-2020_10-59-33'

trajectory = h5py.File('hdf5/'+trajectory_name+'.hdf5', 'r')
TEST_FUNCTION_NAME = 'sixhump_camel'
...
plt.title('SixHumpCamel2D', fontsize=BIGGER_SIZE)
plt.hlines(-1.0316, 0, n_initial_queries+n_actual_queries+1, colors='k', linestyles='dashed')
plt.ylim(-2.5, 20)
plt.show()
# Add rectangle
plt.gca().add_patch(patches.Rectangle((0,-2.5),100,1.41,linewidth=1,edgecolor='w',facecolor='w',zorder=2))
...
plt.show()
# Add rectangle
plt.gca().add_patch(patches.Rectangle((0,-0.1),100,0.098,linewidth=1,edgecolor='w',facecolor='w',zorder=2))
