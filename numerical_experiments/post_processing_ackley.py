...
trajectory_name = 'numerical_experiments_trajectory_20-05-2020_20-55-44'
...
pbo_dts = PBO_runs[list(PBO_runs.keys())[5]]
...
pbo = PBO_runs[list(PBO_runs.keys())[6]]
...
plt.title('Ackley20D', fontsize=BIGGER_SIZE)
